...
Battery energy consumption prediction for electric vehicles using machine learning.
...
│   └── training_job.job.yml   # ML training job
├── src/                        # Production code
│   ├── battery_energy_prediction_training.py  # Main training notebook
│   └── README.md
├── experiments/                # Experimental notebooks and MLflow experiments
│   ├── battery_energy_prediction  # MLflow experiment
│   └── README.md
└── README.md
```
